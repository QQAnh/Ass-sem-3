...
<%--<form method="post" action="/register">--%>
    <%--username <input name="username" type="text" value="<%account.getUsername();%>"><br>--%>
    <%--<% if (errors.containsKey("username")) {%>--%>
    <%--<span><%= errors.get("username")%></span>--%>
    <%--<%}%>--%>
    <%--password <input name="password" type="password"><br>--%>
    <%--role <input name="role" type="number"><br>--%>
    <%--<input type="submit">--%>
<%--</form>--%>
...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form action="/register" method="post">
            ...
            <%}%>
            <input type="text" id="role" name="role" class="fadeIn third" placeholder="Role">
