...
<div class="wrapper fadeInDown">
    <div id="formContent">
        <form action="/phone" method="post">
            ...
            <%}%>
            <input type="text" id="price" name="price" class="fadeIn third" placeholder="Price">
            <% if (errors.containsKey("price")) {%>
            <span><%= errors.get("price")%></span>
            <%}%>
            <input type="text" id="description" name="description" class="fadeIn third" placeholder="description">
            <% if (errors.containsKey("description")) {%>
            <span><%= errors.get("description")%></span>
            <%}%>
            <select name="brand" id="brand" class="fadeIn third">
